      ...
      <SidebarContext.Provider value={contextValue}>
        <TooltipProvider delayDuration={0}>
          <div
            ...
            className={cn(
              'group/sidebar-wrapper flex flex-1 w-full has-[[data-variant=inset]]:bg-sidebar',
              className,
            )}
            ref={ref}
            {...props}
    ...
    return (
      <div
        ...
        className={cn(
          ...
          'sticky top-0 z-10 h-screen w-[--sidebar-width] shrink-0 overflow-y-auto transition-[width] duration-200 ease-linear',
...
>(({ className, showIcon = false, ...props }, ref) => {
  // Stable pseudo-random width between 50% and 90%, derived from component id.
